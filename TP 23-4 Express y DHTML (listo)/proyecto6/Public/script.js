...
function reiniciarFormulario() {
    // Limpiar inputs de texto/número/email
    ...
    // Ocultar resultado y limpiar sus datos
    document.getElementById('resultado').classList.add('oculto');
    document.getElementById('datos').innerHTML = '';

    // Ocultar mensaje de error si quedó visible
    ...
    // Volver a deshabilitar este mismo botón
